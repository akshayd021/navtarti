  ...
  return (
    <div>
        ...
        <div className="flex flex-col justify-start items-start h-full p-6">
          <div className="max-w-lg text-left mt-20 ml-14">
            ...
            <p className="mt-5 text-2xl text-center font-semibold font-Lexend  text-white">
              10 Nights of Glory, Grace, and Gold—Get ready to Ignite the spirit
              of divine goddess!
            </p>
          </div>
        </div>
      ...
      <div className="flex justify-between gap-10 mt-10 px-5">
        <div className="flex flex-col w-1/2">
          <h1 className="text-[25px] text-left font-bold mb-1 text-[#232323]">
            SUVARN NAVRATRI, SURAT -{" "}
            <span className="text-[#5D0179]">2024</span>{" "}
          </h1>
          ...
          <ul className="list-disc text-left ml-10 text-[#929292] ">
            <li>
              With 10 years of experience in organizing the biggest Navratri
              event in India.
            </li>
            <li>
              Enjoy performances by the best folk singers from India, bringing
              authentic music and energy.
            </li>
            <li>
              {" "}
              Experience the fully air-conditioned Navratri festival in Surat,
              ensuring comfort throughout the celebrations.{" "}
            </li>
            <li>
              Garba to the beats powered by the world's best band and renowned
              sound artists.
            </li>
            <li>
              Benefit from extensive secure parking areas, ensuring a
              hassle-free experience.
            </li>
          </ul>
          <p className="text-[#b3b3b3] text-left font-Lexend mt-1">
            Join us for an unforgettable celebration filled with music, garba,
            and joy!
          </p>
          <h3 className="text-[#004a77] mt-1 underline inline-flex text-[18px] font-Lexend">
            Find us on the map to Our Location
          </h3>
        </div>
      ...
      <div className="bg-[#f5f5f5] border-y py-10">
        <h3 className="font-Great text-[#232323] text-[30px] text-center">
          Enjoy Suvarn Offers This Navratri Season!
        </h3>
        <h2 className="font-Lexend text-[22px] text-[#232323] mt-1 font-[600] text-center">
          Navratri Offers for You!
        </h2>
        <div className="flex justify-center items-center gap-10 mt-10 mx-auto">
          <div className="flex flex-col items-center">
            <img src={off1} alt="8% off" className="w-[295px]" />
            <p className="text-[#3a0946] mt-1 text-[20px] font-bold">
              Use code SNOFF8%
            </p>
          </div>
          <div className="flex flex-col items-center">
      ...
      <div className="my-10 px-10">
        <h2 className="text-[32px] font-Great  text-black text-center">
          Event Gifts
        </h2>
        <h1 className="text-black text-[32px] font-[600] text-center">
        ...
        <div className="flex justify-center items-center gap-10 mt-6">
          ...
          <div className="w-1/2 text-left">
            ...
            <p className="text-[18px] text-black font-[600] mt-2">
              Fun Festival Raatri Delight with Navratri exclusive gifts!
              Participate and add joy with the following range of gifts:
            </p>
